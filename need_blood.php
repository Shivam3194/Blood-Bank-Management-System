...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT * from receivers where flag = 0 && rbg='$searchKey'";
}else{
    $sql = "SELECT * from receivers where flag = 0";
}
    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">Select Blood Group:</label>
               ...
               <a href="need_blood.php" class="btn btn-info mr-4"> Reset</a>
               <input type="submit" name="submit" class="btn btn-info" value="search">
           </form>
        </div>

        <table class="table table-responsive table-striped rounded mb-5">
            <tr><th colspan="7" class="title">Donating Blood Samples</th></tr>
            <tr>
                <th>#</th>
                <th>Donor Name</th>
                <th>Donor City</th>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><input type="submit" name="request" class="btn btn-info" value="Request Blood"></td>
                <?php } ?>
